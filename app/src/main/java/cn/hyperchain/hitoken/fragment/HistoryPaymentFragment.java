...
public class HistoryPaymentFragment extends BaseHistoryFragment {
    ...
    public void netRequestAction(final int action, HashMap<String, String> body) {
        ...
        RetrofitUtil.getService().getTxlist(address,type,pageIndex,pageSize,true,false).enqueue(new CancelableCallback<MyResult<List<HistoryInfo>>>() {
            @Override
