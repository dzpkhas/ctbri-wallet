...
public class HistoryGatheringFragment extends BaseHistoryFragment {
    ...
    public void netRequestAction(final int action, HashMap<String, String> body) {
        ...
        RetrofitUtil.getService().getTxlist(address,type,pageIndex,pageSize,false,true).enqueue(new CancelableCallback<MyResult<List<HistoryInfo>>>() {
            @Override
