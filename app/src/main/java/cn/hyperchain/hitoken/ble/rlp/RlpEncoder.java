package cn.hyperchain.hitoken.ble.rlp;

import java.util.Arrays;
import java.util.List;

import static cn.hyperchain.hitoken.ble.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static cn.hyperchain.hitoken.ble.rlp.RlpDecoder.OFFSET_SHORT_STRING;
