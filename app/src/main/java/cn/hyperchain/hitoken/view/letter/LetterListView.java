package cn.hyperchain.hitoken.view.letter;
...
public class LetterListView extends View {
    ...
    private int textDefaultColor = Color.parseColor("#DE000000");
    private int textFocusColor = Color.parseColor("#00000000");
    ...
    public void setup(Context context) {
        ...
        textSize = DataUtils.dp2px(context, 12);
    }
