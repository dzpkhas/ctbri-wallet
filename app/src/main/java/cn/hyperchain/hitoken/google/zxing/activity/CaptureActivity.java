package cn.hyperchain.hitoken.google.zxing.activity;
...
import cn.hyperchain.hitoken.google.zxing.camera.CameraManager;
import cn.hyperchain.hitoken.google.zxing.decoding.CaptureActivityHandler;
import cn.hyperchain.hitoken.google.zxing.decoding.InactivityTimer;
import cn.hyperchain.hitoken.google.zxing.decoding.RGBLuminanceSource;
import cn.hyperchain.hitoken.google.zxing.view.ViewfinderView;
 ...
 * @author Ryan.Tang
 */
public class CaptureActivity extends TemplateActivity implements Callback {
        ...
        ivLight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(parameter.getFlashMode().equals("off")) {
                    isOpen = false;
                    ivLight.setImageResource(R.mipmap.light_gray);
                } else {
                    isOpen = true;
                    ivLight.setImageResource(R.mipmap.light_bright);
                }
                // 关灯
                if (isOpen) {
